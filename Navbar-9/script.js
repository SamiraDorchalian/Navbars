...
bodyEl.innerHTML = `
    ...
    <div class="hero">
        <header id="masthead" role="banner">
            <div class="container">
                <button class="hamburger hamburger--biring" type="button">
                    <span class="hamburger-box">
                        <span class="hamburger-inner"></span>
                    </span>
                    <span class="hamburger-lable">Menu</span>
                </button>
                <form id="masthead-search">
                    <input type="search" name="S" aria-labelledby="search-label" placeholder="search&hellip;" class="drow">
